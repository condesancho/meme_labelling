...
# The code that used as starting point for the implementation can be found here:
...
def vit(
    ...
    vit_model = keras.Model(inputs=inputs, outputs=y)

    # Add MLP.
    features = mlp(y, hidden_units=mlp_head_units, dropout_rate=mlp_dropout)
    # Classify outputs.
    output = layers.Dense(4, activation="softmax")(features)
